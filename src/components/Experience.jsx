...
import { GradientText, AnimatedList, BlurText } from './reactbits';
                ...
                <div className="flex flex-col max-w-[1200px] w-full px-6 lg:px-10">
                    ...
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
                            <BlurText
                                text="Building data platforms across startups and enterprises"
                                delay={0.05}
                                animateBy="words"
                                direction="top"
                            />
                            ...
                            {experience.map((exp, index) => (
                                ...
                                >
                                    ...
                                    <div className={`ml-20 lg:ml-0 lg:w-[calc(50%-2rem)] ${index % 2 === 0 ? 'lg:pl-12' : 'lg:pr-12'
                                        ...
                                        <div className="group bg-white dark:bg-surface-dark rounded-2xl border border-slate-200 dark:border-slate-700 p-6 hover:shadow-xl hover:shadow-slate-200/50 dark:hover:shadow-none transition-all hover:-translate-y-1 hover:border-primary/30">
                                            {/* Mobile Date */}
                                            ...
                                            <div className="flex flex-wrap gap-2 pt-4 border-t border-slate-100 dark:border-slate-700">
                                                {exp.technologies.map((tech) => (
                                                    <span
                                                        key={tech}
                                                        className="px-2.5 py-1 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-xs font-medium rounded-md hover:bg-primary/10 hover:text-primary transition-colors"
                                                    >
                                                        {tech}
                                                    </span>
                                                ))}
